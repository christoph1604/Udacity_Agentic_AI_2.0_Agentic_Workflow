...
class AugmentedPromptAgent:
    ...
    def respond(self, input_text):
        ...
        response = client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": "You are an "+self.persona+". Forget any previous context and answer the question in your given role."},
...
class KnowledgeAugmentedPromptAgent:
    ...
    def respond(self, input_text):
        ...
        response = client.chat.completions.create(
            model="gpt-3.5-turbo",
            messages=[
                {"role": "system", "content": "You are an "+self.persona+" knowledge-based assistant. Forget all previous context."+
